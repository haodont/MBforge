...
so the module lives alongside the record type in :mod:`mbforge.application.pipeline`.
"""
...
from mbforge.application.pipeline.detection.label_normalization import LabelKind
...
def correct_molecules_with_context(
    ...
    Args:
        molecules: Output of :func:`mbforge.application.pipeline.detection.normalization.normalize_molecules`.
