...
from mbforge.domain.patent import compound_label_key


class LabelKind(str, Enum):  # noqa: UP042 — matches existing Enum-string pattern in mbforge.application.dto.agent
