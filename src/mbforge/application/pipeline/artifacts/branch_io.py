...
from mbforge.application.pipeline.artifacts.json_io import (
    read_json_object,
    write_json_atomic,
)
...
def build_detection_artifact(
    ...
    *,
    ...
    """
    from mbforge.application.pipeline.artifacts.evidence_models import DetectionArtifact
    ...
    from mbforge.application.pipeline.artifacts.evidence_models import DetectionPage
