...
See :mod:`mbforge.application.pipeline.extract.pages` for the contract.
"""
...
from mbforge.application.pipeline.activity.matching import (
...
def persist_molecule_candidates(
    ...
    Args:
        ...
        candidates: Molecule candidates produced by
            :mod:`mbforge.application.pipeline.detection.normalization`.
