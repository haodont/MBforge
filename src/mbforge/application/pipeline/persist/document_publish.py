...
module is called by :mod:`mbforge.application.pipeline.stages.persist_stage` around
them.
"""
...
from mbforge.foundation.files import ensure_dir, save_json
from mbforge.foundation.layout import LibraryLayout
from mbforge.foundation.logger import get_logger

logger = get_logger("mbforge.application.pipeline.persist.document_publish")
