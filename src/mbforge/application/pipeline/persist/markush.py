...
from mbforge.domain.molecule import MarkushFragment, MarkushScaffold, Molecule
from mbforge.foundation.ids import stable_id
from mbforge.foundation.logger import get_logger

logger = get_logger("mbforge.application.pipeline.persist.markush")
...
def _coref_label(molecule: Molecule, key: str) -> str:
    ...
    1. ``normalized_label`` — the canonical form written by
       :mod:`mbforge.application.pipeline.detection.label_normalization`. This is the new contract.
