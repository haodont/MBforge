...
logger = get_logger("mbforge.application.pipeline.activity.parsing.tables")
...
def _parse_simple_activity_table(
    ...
    *,
    ...
    from mbforge.application.pipeline.activity.extraction import _build_activity_record
