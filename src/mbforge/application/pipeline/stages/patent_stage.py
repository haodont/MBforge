...
from mbforge.application.pipeline.patent.artifact import (
    PatentFactsArtifact,
    PatentSectionModel,
)
from mbforge.application.pipeline.patent.association import associate_facts
...
logger = get_logger("mbforge.application.pipeline.stages.patent")
...
def extract_entries_from_title(
    ...
    *,
    ...
    """
    from mbforge.domain.patent import (
        ROLE_EXAMPLE,
        ROLE_PREPARATION,
        CompoundEntry,
        entry_id,
...
def extract_assay_method_from_title(
    ...
    *,
    ...
    """
    from mbforge.domain.activity import AssayMethod, assay_method_id
...
class PatentStage:
    ...
    def _extract(self, ctx: PipelineContext, cancel_check) -> ExtractionOutcome:
        ...
        from mbforge.application.pipeline.artifacts.hydration import load_detections
