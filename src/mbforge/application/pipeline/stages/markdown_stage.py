...
from mbforge.application.pipeline.markdown.esmiles_insert import _HEADING_PATTERNS
...
logger = get_logger("mbforge.application.pipeline.stages.markdown")
...
class MarkdownStage:
    ...
    def execute(self, ctx: PipelineContext) -> StageResult:
        ...
        from mbforge.application.pipeline.markdown.esmiles_insert import (
