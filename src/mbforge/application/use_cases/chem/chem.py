...
from mbforge.application.use_cases.molecule.queries import (
    similarity_search_db,
    substructure_search_db,
)
...
def draw_smiles_sync(smiles: str, width: int, height: int):
    ...
    from mbforge.application.dto.chem import SmilesImageResponse
...
def markush_parse_sync(smiles: str) -> dict:
    ...
    from mbforge.domain.markush import parse_markush, parse_response
...
def markush_check_sync(esmiles: str, query: str) -> dict:
    ...
    from mbforge.domain.markush import (
