...
def _ocr_mode_from_config() -> str:
    ...
    from .crop_labels import _ocr_mode
...
class LabelReader:
    ...
    def is_available(self) -> bool:
        ...
        if self._mode == "daemon":
            ...
            try:
                ...
                return False
        from .crop_labels import _create_engine, _engine_name
    ...
    def read(self, image):
        ...
        from .crop_labels import extract_label_reads
    ...
    def unload(self) -> None:
        ...
        if self._mode == "daemon":
            from .daemon_client import unload_daemon

            unload_daemon()
            self._engine = _engine_name_from_config()
            return
        from . import crop_labels
