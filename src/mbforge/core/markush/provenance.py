...
if TYPE_CHECKING:
    from ..detection.types import NormalizedMolecule
...
def _join_context_text(molecule: NormalizedMolecule) -> str:
...
def _candidate_properties(molecule: NormalizedMolecule) -> dict[str, Any]:
