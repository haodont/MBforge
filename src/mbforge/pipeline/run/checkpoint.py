...
from mbforge.pipeline import stages as _stage_modules  # noqa: F401
from mbforge.pipeline.composition import effective_stage_names
from mbforge.storage.layout import LibraryLayout
from mbforge.utils.ids import short_id
from mbforge.utils.logger import get_logger

logger = get_logger("mbforge.pipeline.run.checkpoint")
...
def mint_checkpoint_run_id() -> str:
    ...
    :func:`mbforge.pipeline.run.ids.mint_run_id` instead.
    """
    return short_id()
