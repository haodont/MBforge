...
delegate to :mod:`mbforge.application.use_cases.molecule.queries`.
"""
...
from mbforge.application.dto.molecule import (
...
async def mol_recorrect(body: MoleculeRecorrectRequest) -> MoleculeRecorrectResponse:
    ...
    """
    from mbforge.application.use_cases.molecule.recorrection import recorrect_molecules
