...
shapes used across :mod:`mbforge.adapters.runtime.resource_manager`, the cache-discovery
module (:mod:`mbforge.adapters.runtime.model_locator`) and the downloader
(:mod:`mbforge.adapters.runtime.model_downloader`). Keeping them in a dependency-free
