...
pipeline layer (``mbforge.application.pipeline.layout.labels``) so this backend stays a
pure detector.
...
matching :mod:`mbforge.adapters.inference.moldet_v2_ft`. The PDF-point conversion happens
